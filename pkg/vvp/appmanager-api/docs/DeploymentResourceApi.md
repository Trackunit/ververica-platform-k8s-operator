...
> Deployment UpsertDeploymentUsingPUT(ctx, deploymentRequest, name, namespace, optional)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **deploymentRequest** | [**ObjectNode**](ObjectNode.md)| deploymentRequest | 
  **name** | **string**| name | 
  **namespace** | **string**| namespace | 
 ...
 **applyDefaults** | **optional.Bool**| applyDefaults | [default to true]
